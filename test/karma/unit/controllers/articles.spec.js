(function() {
    ...
    describe('OSC controllers', function() {
        ...
        describe('ArticlesController', function() {
            ...
            // If we were to use the standard toEqual matcher, our tests would fail because the test values would not
            // match the responses exactly. To solve the problem, we use a newly-defined toEqualData Jasmine matcher.
            ...
            it('$scope.update() should update a valid article', inject(function(Articles) {
                ...
                // testing the body data is out for now until an idea for
                // testing the dynamic updated array value is figured out
                ...
                GOT:      {"_id":"525a8422f6d0f87f0e407a33","title":"An Article about MEAN",
                            "to":"MEAN is great!","updated":[1383534772975]}
                */
